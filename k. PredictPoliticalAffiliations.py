...
voting_data = pd.read_csv('files/house-votes-84.data.txt', na_values=['?'], names = feature_names)
# voting_data.head()
...
# Now use scikit_learn's cross_val_score to evaluate this model identically to the others
